...
public class ListDemo {
    public static void main(String[] args) {
        ...
        // The list iterator method creates a new list Iterator that is postitioned at
         ...
         * or previous and any adds in between "next" and "remove" will result in an
         * error
         */
        ...
        /*
         * The hasNext method is used to determine if there s a next node after the
         * iteratpr .
         ...
         * 
         * Can't modify a linked list whule using an teration UNLESS iterator is ued to
         * do modification
         */
        ...
        while (iterator.hasNext()) {
            String n = iterator.next();
            if (n.equals("Tony")) {
                staff.remove("Tony"); // will give problem because not using iterator :
